...
.btn-clear:active {
    ...
    <!-- Shared UI polish: unified motion + full mobile/tablet layout (loaded last) -->
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr class="animate__animated animate__fadeIn">
                                    ...
                                    <td data-label="Transaction ID"><span class="badge badge-light">#${sale.id}</span></td>
                                    ...
                                    <td data-label="Subtotal">LKR ${sale.subtotal}</td>
                                    <td data-label="Tax">LKR ${sale.tax}</td>
                                    <td data-label="Total"><strong>LKR ${sale.total}</strong></td>
                                    <td data-label="Payment"><span class="badge ${sale.paymentMethod == 'Cash' ? 'badge-cash' : 'badge-card'}">${sale.paymentMethod}</span></td>
